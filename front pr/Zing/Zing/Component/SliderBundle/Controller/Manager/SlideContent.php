...
use Zing\Component\SliderBundle\Entity\SlideContent as Entity;

/** Slider crud manager */
class SlideContent extends CoreManager implements ManagerInterface
{
     ...
     */
    public function prepareSlideContent($object = null) {
        $prepare = $this->entity;
        if($object != null) {
            $prepare = $object;
        }

        return $prepare ->setStatus(1)
