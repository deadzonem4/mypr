 ...
 * NewsUrl
 *
 * @ORM\Table(name="zing_news_url")
 * @ORM\Entity
 */
class NewsUrl implements ZingEntityInterface
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Zing\Component\NewsBundle\Entity\News", inversedBy="url")
     */
    private $news;
