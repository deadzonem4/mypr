 ...
 * ManufactureContent
 *
 * @ORM\Table(name="zing_simplestore_manufacture_content")
 * @ORM\Entity
 */
class ManufactureContent implements ZingEntityInterface
{
    /**
     * @var integer
     *
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Zing\Component\SimpleStoreBundle\Entity\Manufacture", inversedBy="content")
     */
    private $manufacture;
