...
use Zing\Component\SimpleStoreBundle\Entity\Category as Entity;
use Zing\Component\SimpleStoreBundle\Entity\CategoryContent as CategoryContent;
...
class Category extends CoreManager implements ManagerInterface
{
    ...
    private $repository_name = 'ZingComponentSimpleStoreBundle:Category';
    /** @var object $repository SimpleStore category repository */
    private $repository;
    ...
    /** Prepare the SimpleStore category object
    ...
    public function prepareCategory($request, $category_object = null) {
        ...
        foreach($this->activeLanguages() as $lang) {
            ...
            if(isset($request[$lang])) {
                ...
                $category_content_manager = $this->requestService('zing.component.simplestore.category_content');

                /** Call category url manager */
                $category_url_manager     = $this->requestService('zing.component.simplestore.category_url');
                ...
                if($category_url == null) {
                    $category_url = new \Zing\Component\SimpleStoreBundle\Entity\CategoryUrl();
    ...
    {
        $category = $this    ->requestService('zing.component.simplestore.category_url')
            ->getCategoryUrlBy(array('url' => str_replace('/store', '', $url)));
    ...
    /** Set a new SimpleStore category
    ...
    /** Update a already created SimpleStore category
