                            ...
                            <div class="row footer_row">
								<div class="small-12 medium-6 large-4 columns">
									<div id="footer_about" class="footer_box">
										<div class="footer_heading">About THE BRAND</div>
										<p>BEA Sportswear was born in Bulgaria in 2016 thanks to the intuition
										and creative thinking of Beatris Borshukova ...
										<a href="/about-us">Learn more</a></p>
										<p class="footer_copyright">Bea Sportswearʩ 2018. All Rights Reserved. </p>
									</div>
                                </div>    

                                <div class="small-12 medium-6 large-4 columns">
									<div id="footer_nav" class="footer_box">
								...
								<div class="show-for-medium-only clearfix"></div>
                                <div class="small-12 medium-6 large-4 columns float-left">
                                	<div id="footer_contact" class="footer_box">
                                		<div class="footer_heading">Contact Us</div>
                                		<p>Address: CKF Studio Ltd., Evlogi Georgiev 24 Sofia 1164 Bulgaria
											<br />Open: Mon-Sat: 11:20 ; Sunday: 10-18</p>
										<p>Call us:  <a href="tel:+359 88 7668876">+359 88 7668876</a></p>
										<p>Email us:  <a href="mailto:borshukova@gmail.com" target="_top">beasportswear@gmail.com</a></p>
                                	</div>                    									                        
								</div><!--.large-4-->
							</div><!-- .row --> 
	                    ...
	                    <div class="offcanvas_content_right">
	                        ...
	                        <div id="mobiles-menu-offcanvas">
		                            ...
		                            <?php if ( (isset($shopkeeper_theme_options['main_header_layout'])) && ( $shopkeeper_theme_options['main_header_layout'] != "2" ) && ( $shopkeeper_theme_options['main_header_layout'] != "22" ) ) : ?>
										...
										<?php if( has_nav_menu("mobile-navigation") ) : ?>
			                                <nav class="mobile-navigation secondary-navigation hide-for-large" role="navigation">
												<h2>Useful links</h3>
												<?php 
													wp_nav_menu(array(
