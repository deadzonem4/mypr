...
$lot_size = es_the_formatted_lot_size( '', '', false);
    ...
    <div class="es-property-inner">
        <div class="es-property-thumbnail">
            <div class="es-thumbnail">
                <?php 
                    if(get_field('property_sold') == 'sold'):
                ?>
                    <div class="label-sold"><?php _e('Sold','Sold'); ?></div>

                <?php elseif(get_field('property_sold') == 'rented'): ?>
                    <div class="label-sold"><?php _e('Rented out','Rented out'); ?></div>
                <?php endif; ?>
        ...
        <div class="es-property-info">
            ...
            <div class="es-bottom-info">
                ...
                <?php if ( !empty( $lot_size ) || !empty( $bedrooms ) || !empty( $bathrooms ) ):?>
                    <div class="es-bottom-icon-cols">
                        <?php if ( !empty( $lot_size ) ):?>
                             <span class="es-bottom-icon"><i class="es-icon es-squirefit" aria-hidden="true"></i> <?php es_the_formatted_lot_size(); ?></span>
                        <?php endif;?>
