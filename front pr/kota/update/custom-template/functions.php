...
if (!is_admin()) {
	...
	function twbs_load_styles() {
		...
		//Aos
		wp_register_style('aos-styles', get_template_directory_uri() .'/assets/dist/js/aos-master/dist/aos.css' , array(), null, 'all');
		...
		// // Load Javascript
		wp_enqueue_script('aos-js', get_template_directory_uri() .'/assets/dist/js/aos-master/dist/aos.js', array());
...
// Bigger inputs for address in Add New Property
add_action('admin_head', 'my_custom_fonts');

function my_custom_fonts() {
  echo '<style>
    #es-address .es-field .es-field__content {
