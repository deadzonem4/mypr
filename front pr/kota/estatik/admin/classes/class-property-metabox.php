...
class Es_Property_Metabox extends Es_Object
{
    ...
    public static function render()
    {
        if ( $tabs = static::get_tabs() ) {
            $template = apply_filters( 'es_property_metabox_template_path', ES_ADMIN_TEMPLATES . 'property/metabox.php' ) ;
            include ( $template );
        }
    }
    ...
    public static function get_tabs()
    {
        return apply_filters( 'es_property_metabox_tabs', array(
            'es-basic-info' => array( 'label' => __( 'Basic information', 'es-plugin' ) ),
