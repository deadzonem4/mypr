...
<main id="content">
	...
	<div class="container">
		<section class="product-info row">
			<div href="#" class="col-xs-4">
				<div class="product-info-img ">
					<img class="restorant-logo-img" src="images/pizza-logo.png">
					<a href="#">
		...
		<aside>
			...
			<p>Промоция 1 - Lorem Ipsum е елементарен примерен текст, ползва се в печатарската и типограф…<span><a href="#">виж още</a></span></p>
			</div>
		</aside>
		<section class="product-list-title-red row">
			<div class="col-xs-12">
				<p>Пици</p>
				<div class="detail-grey-line"></div>
				...
				<div class="product-box clearfix">
					...
					<div class="product-box-cont col-xs-9">
						<div class="product-box-title">
							...
							<li><img class="wth18" src="images/star.svg"><span>8,5</span></li>
							</ul>
						</div>
