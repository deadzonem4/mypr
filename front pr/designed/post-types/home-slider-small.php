          	<div class="item tranz">
                ...
                <div class="entryhead">
					...
					<?php if ( has_post_thumbnail()){ ?>
                        ...
                        <a href="<?php designed_permalink(); ?>">
                            <?php the_post_thumbnail('designed_single',array('class' => 'tranz grayscale grayscale-fade nolazy'));  ?>
                        </a>
                ...
                <div class="flexinside">
                    ...
                    <p class="teaser"><?php echo esc_attr(designed_excerpt( get_the_excerpt(), '190')); ?><span>...</span></p>
