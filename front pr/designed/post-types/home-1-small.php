          	<div <?php post_class('item p-border tranz'); ?>>
            	...
            	<div class="item_inn tranz p-border">
                    ...
                    <h3 class="posttitle"><a class="link link--forsure" href="<?php designed_permalink(); ?>"><?php the_title(); ?></a></h3>
                    
                    <?php if (function_exists('wp_review_show_total')) wp_review_show_total(); ?>
                    
                    <p class="teaser"><?php echo designed_excerpt( get_the_excerpt(), '180'); ?><span>...</span></p>
