<?php
/** A simple text block **/
class ML_Home_1 extends ML_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => esc_html__('Mag 1 (Free)','designed'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('ML_Home_1', $block_options);
	}
	
	function form($instance) {
                
		$defaults = array('title' => 'Recent Posts', 'subtitle' => 'Optional Subtitle', 'moretitle' => '','urlmore' => '','post_type' => 'all', 'categories' => 'all', 'posts' => 8,'offset_posts' => "",'right_lay' => 0,'no_margin' => 0, 'media_type_sel' => 'Featured Image', 'block_bg_color' => '#4591b8','block_text_color' => '#fff');
		...
		?>
            ...
            <div class="mag-block mag-one">
                ...
                ?>
                	...
                	<?php include( get_template_directory() . '/post-types/home-1-small.php'); ?>
