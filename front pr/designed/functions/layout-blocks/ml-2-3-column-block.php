...
class ML_2_3_Column_Block extends ML_Block {
	...
	function __construct() {
		...
		$block_options = array(
			...
			'name' => esc_html__('Wide Column','designed'),
		...
		parent::__construct('ml_2_3_column_block', $block_options);
	...
	function form($instance) {
		...
		__('Wide Column - Drag block items into this column box','designed'),
