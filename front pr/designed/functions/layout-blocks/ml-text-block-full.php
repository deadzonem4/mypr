<?php
/** A simple text block **/
class ML_Text_Block_Full extends ML_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => esc_html__('Text & Divider** (Full Width)','designed'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('ml_text_block_full', $block_options);
	}
