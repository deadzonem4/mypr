<?php
/** A simple text block **/
class ML_Home_2 extends ML_Block {
	
	//set and create block
	function __construct() {
		$block_options = array(
			'name' => esc_html__('Mag 2 (Free)','designed'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('ML_Home_2', $block_options);
	}
    ...
    ?>
		...
		?>
			...
			?>          
                <div class="mag-block mag-two ghost">
                ...
                ?>
                	...
                	<?php include( get_template_directory() . '/post-types/home-2-big.php'); ?>
                
                <?php else: ?>
                
                	<?php include( get_template_directory() . '/post-types/home-2-small.php'); ?>
