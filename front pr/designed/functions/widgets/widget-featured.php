<?php
add_action('widgets_init', 'designed_featured_widget');

function designed_featured_widget()
{
	register_widget('designed_featured_widget');
}

class designed_featured_widget extends WP_Widget {
	
	function designed_featured_widget()
	{
		$widget_ops = array('classname' => 'designed_featured_widget', 'description' => esc_html__('Featured posts widget.','designed'));

		$control_ops = array('id_base' => 'designed_featured_widget');

		$this->__construct('designed_featured_widget', esc_html__('Themnific - Featured','designed'), $widget_ops, $control_ops);
	}
