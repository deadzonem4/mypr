<footer id="footer">
      <section class="footer-main">
        <div class="container">
                <a href="http://me-apps.com/" class="footer-logo-box"></a>
      ...
      <section class="all-rights">
         <div class="container">
           <div class="row">
             <p class="col-sm-6 col-xs-12">© 2017 Me-apps.bg. All rights reserved.</p>
             <div class="col-xs-6 right-footer-items">
             <a href="http://3web-studio.com/" class="text-right">
             Design and development</a>
             <a  href="http://3web-studio.com/" class="footer-company-img"></a>
            </div>
           </div>
         </div>
      </section>
