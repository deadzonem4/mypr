...
<head>
    ...
    <title><?php echo (isset($data['title']) ? $data['title'] : "News Lab") ?></title>
                ...
                <nav class="navbar navbar-default navbar-fixed-top">
                    <div class="container">
                        <div class="navbar-header">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo base_url(); ?>" class="navbar-brand cursive logo">News Lab</a>
                        </div>
                        <?php if(!isset($data['pdf']) || $data['pdf'] == FALSE): ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-right">
                    <p>
                        &copy; <?php echo date('Y'); ?> Rosen Georgiev. All rights reserved.<br />
                        Application developed by <a href="http://plus-dev.co.nf/" target="_blank">RosenDevelopmen</a>.
                    </p>
                </div>
            </div>
        </div>
